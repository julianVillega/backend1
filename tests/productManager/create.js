...
async function test() {
  ...
  try {
    ...
    console.log(await a.create("", 1950, 350, "almacen"));
  } catch (error) {
    console.log(error);
  }
  ...
  try {
    ...
    console.log(
      await a.create("pan de mesa bimbo 360 Gr", undefined, 350, "almacen")
    );
  } catch (error) {
    console.log(error);
  }
  ...
  try {
    ...
    console.log(
      await a.create("pan de mesa bimbo 360 Gr", 5000, undefined, "almacen")
    );
  } catch (error) {
    console.log(error);
  }
  ...
  try {
    ...
    console.log(
      await a.create("alfajor jorgito x3 unidades", 2500, 350, undefined)
    );
  } catch (error) {
    console.log(error);
  }
